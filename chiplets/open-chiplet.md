...
!\[Figure 1 - OpenChiplet IO version](images/open\_chiplet\_io.png)

Figure 1 - OpenChiplet IO application

!\[Figure 2 - OpenChiplet Accelerator version](images/open\_chiplet\_accel.png)

Figure 2 - OpenChiplet accelerator application

!\[Figure 3 - OpenChiplet Wireless/sensor version](images/open\_chiplet\_wireless.png)
...
!\[Figure 4 - OpenChiplet Example System-in-Package](images/open\_chiplet\_example\_system.png)
...
configuration.
* `OCML\_ADDR` (informative) is used in multi-chiplet systems where a unique
...
!\[Figure 5 - OpenChiplet Dimensions](images/open\_chiplet\_dimensions.png)
...
!\[Figure 6 - OpenChiplet die area comparison](images/open\_chiplet\_die\_area.png)
